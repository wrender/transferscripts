...
def buildaptmirror():
    ...
    try:
        ...
        client.images.build(tag='apt-mirror:v1.0',path='/opt/mirrorsync/apt_mirror/files/',network_mode=cfg['mirrorsync']['networkmode'],use_config_proxy=cfg['mirrorsync']['configproxy'],rm=True)
