...
def buildcontainermirror():
    ...
    try:
        ...
        client.images.build(tag='container-mirror:v1.0',path='/opt/mirrorsync/container_mirror/files/',network_mode=cfg['mirrorsync']['networkmode'],use_config_proxy=cfg['mirrorsync']['configproxy'],rm=True)
