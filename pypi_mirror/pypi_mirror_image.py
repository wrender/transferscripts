...
def buildpypimirror():
    ...
    try:
        ...
        client.images.build(tag='pypi-mirror:v1.0',path='/opt/mirrorsync/pypi_mirror/files/',network_mode=cfg['mirrorsync']['networkmode'],use_config_proxy=cfg['mirrorsync']['configproxy'],rm=True)
